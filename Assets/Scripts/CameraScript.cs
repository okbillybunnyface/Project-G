...
public class CameraScript : MonoBehaviour {
	...
	void Start () 
	{
		...
		independentTime = Time.realtimeSinceStartup;
	}
	...
	void Update()
	{
		...
		transform.position = Vector3.SmoothDamp(transform.position, look, ref currVelocity, lookTime, float.MaxValue, Time.realtimeSinceStartup - independentTime);
		independentTime = Time.realtimeSinceStartup;
